# Starter Module — Backend Development Guide
...
| Identifier | Value |
|---|---|
| **Script ID** | `13jRb_he5r7sD5XA1vbAVqS2x-lFzM3JEJ9fkusgl0joL5jlOKf3HtdSA` |
| **Deployment ID** | `AKfycbykwDFrvKj5vnScj16Y1cb9FA5TkS5I0yss1RrX6ps8N04seU1Tlhi5s_V8ZuNzgvlK` |
...
```bash
# From the app root (starter-module/)
bash cicd/app-deployment.sh "starter-module: add new endpoint"
```
...
# Select "starter-module" from the menu, enter a commit message
```
