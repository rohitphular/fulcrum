# Card payment / Pay credit card — ADD

> **Type:** `money-transfer`  
> **Category:** Card payment → Pay credit card  
> **Operation:** `add`
...
**Steps on success (same currency — typical):**
...
8. `from_account.current_balance -= amount` (current account decreases)
9. `to_account.current_balance += amount` (credit card balance increases — becomes less negative, reducing the amount owed)
10. Standard Reload triggered

**Steps on success (cross-currency):**
