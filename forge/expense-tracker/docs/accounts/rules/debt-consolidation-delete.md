...
- **Archiving is strongly preferred** for debt consolidation accounts with an outstanding balance — the liability data cannot be recovered after deletion.
