...
- **Outstanding balance is lost.** Deleting the account removes the HELOC liability from Net Worth immediately, making net worth appear artificially higher.
- **Archiving is strongly preferred** for HELOC accounts with an outstanding draw balance — the liability data cannot be recovered after deletion.
