...
- `opening_balance` represents the current outstanding balance — entered as a positive number (e.g. `5000`); the backend stores it as `−5000`.
...
- `loan_collateral` does not apply to medical loans (mortgage and auto_loan only).
