...
- **Outstanding balance is lost.** Deleting the account removes the mortgage liability from Net Worth immediately, making net worth appear artificially higher.
- **Archiving is strongly preferred** for mortgage accounts with an outstanding balance — the liability data cannot be recovered after deletion.
