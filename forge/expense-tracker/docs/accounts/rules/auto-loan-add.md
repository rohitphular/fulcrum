...
- `opening_balance` represents the current outstanding balance — entered as a positive number (e.g. `12000`); the backend stores it as `−12000`.
...
- `loan_collateral` is supported for auto loan accounts (e.g. vehicle make, model, registration).
