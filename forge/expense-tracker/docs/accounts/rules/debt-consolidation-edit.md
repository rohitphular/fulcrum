# Debt Consolidation — EDIT

> **Account type:** `debt_consolidation`
> **Group:** Liability
> **Operation:** `edit`
...
- `loan_collateral` is not applicable to debt consolidation loans and is not shown or editable.
...
- `money-out` from a debt consolidation account is hard-blocked by Rule 5 in `transaction-validations.md`, except for `Debt & finance / Interest & charges` (capitalised interest).
