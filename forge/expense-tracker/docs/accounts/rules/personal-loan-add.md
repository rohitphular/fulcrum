...
- `opening_balance` represents the current outstanding balance — entered as a positive number (e.g. `8000`); the backend stores it as `−8000`.
...
- `loan_collateral` does not apply to personal loans (mortgage and auto_loan only).
