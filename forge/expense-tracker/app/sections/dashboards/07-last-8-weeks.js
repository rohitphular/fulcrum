...
export async function render(containerId, { sym }) {
  ...
  if (!container) {
    console.warn('[dashboard-07] container not found:', containerId);
    return null;
  }
  ...
  console.log(`[dashboard-07] income=${totalIncome.toFixed(0)}, expense=${totalExpense.toFixed(0)}, net=${net.toFixed(0)}`);
