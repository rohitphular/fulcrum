...
export async function render(containerId, { accounts, from, to, sym }) {
  ...
  if (!container) {
    console.warn('[dashboard-17] container not found:', containerId);
    return null;
  }
  ...
  console.log(`[dashboard-17] liab_accounts=${liabAccounts.length}, total_outstanding=${totalCurrent.toFixed(0)}`);
