...
export async function render(containerId, { accounts, sym }) {
  ...
  if (!container) {
    console.warn('[dashboard-26] container not found:', containerId);
  ...
  console.log(`[dashboard-26] loans=${loans.length}, total_debt=${totalDebt.toFixed(0)}, monthly_burden=${monthlyBurden.toFixed(0)}`);
