...
export async function render(containerId, { accounts, from, to, sym }) {
  ...
  if (!container) {
    console.warn('[dashboard-16] container not found:', containerId);
    return null;
  }
  ...
  console.log(`[dashboard-16] assets=${currentAssets.toFixed(0)}, liabs=${currentLiabs.toFixed(0)}, net=${currentNet.toFixed(0)}`);
