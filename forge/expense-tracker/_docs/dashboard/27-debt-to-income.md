...
**File:** `sections/dashboards/27-debt-to-income.js`
...
| Utility | Source |
|---|---|
| `monthRange`, `groupByMonth`, `sumAmountBase` | `dashboard-utils.js` |
| `computeDailyTotalAssets` | `dashboard-utils.js` |
| `getCssColors`, `baseChartOptions`, `fmtMonthKey` | `dashboard-utils.js` |
