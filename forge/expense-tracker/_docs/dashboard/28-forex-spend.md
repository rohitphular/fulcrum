# Dashboard 28 — Foreign Currency Spend

**File:** `sections/dashboards/28-forex-spend.js`
**Group:** FX & currency
**Chart type:** Doughnut (By Currency) + Scatter (FX Rates)
**Tabs:** None — internal pill tabs managed by the dashboard itself
...
Two pill buttons rendered inside the dashboard, not in the coordinator tab strip. Attribute pattern: `data-d28-view="currency"` and `data-d28-view="fx-rates"`.
...
Same pattern as dashboards 21 and 22:
